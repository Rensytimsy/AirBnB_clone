...
class TestPlace_instantiation(unittest.TestCase):
    """ this Unittests is testing the instantiation of the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """this is a Unittests that is  testing save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """ this is a Unittests that is testing to_dict method of the Place class."""
