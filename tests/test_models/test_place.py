...
class TestPlace(unittest.TestCase):
    """ A function that Tests for the Place class
    """

    def test_instance(self):
        """ A function that Tests for Place's Instance
        """
        first_place = Place()
        self.assertIsInstance(first_place, Place)

    def test_attributes(self):
        """ A function that Tests if Place has the defined attributes
        """
        first_place = Place()
    ...
    def test_class_name(self):
        """ A function that Checks the type for Place instance
        """
        firstPlace = Place()
