#!/usr/bin/python3
""" This program will test the FileStorage class
"""
import json
import os
import unittest
...
class TestFileStorage(unittest.TestCase):
    """This class somewhat contains the package for FileStorage test
    ...
    def testException(self):
        """ This func Tests the arguments of the save function
        """
    ...
    def testFileStorageAttr(self):
        """This func Checks if the 
        FileStorage class has the attr __file_path
        and __objects
        """
    ...
    def testAll(self):
        """ This func Checks if All method has keys
        """
        my_model = BaseModel()
    ...
    def test_new(self):
        """ This func checks if the to_dicts method key, 
        is the same as when deserialize json file 
        to object and get the key
        """
        my_model = BaseModel()
        dict = my_model.to_dict()
    ...
    def testReload(self):
        """ This func Checks if the path of the __filepath exists and
    ...
    def testSave(self):
        """ This func Checks if the storage
        all and __objects are the same
        """
        self.assertEqual(os.path.exists(storage._FileStorage__file_path), True)
