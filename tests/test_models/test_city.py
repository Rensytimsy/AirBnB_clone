...
class TestCity(unittest.TestCase):
    """ A class that Tests for the City class
    """

    def test_instance(self):
        """ A func to Test for City's Instance
        """
        city_1 = City()
        self.assertIsInstance(city_1, City)

    def test_attributes(self):
        """A func to Tests if City has the defined attributes
        """
        city_1 = City()
    ...
    def test_class_name(self):
        """A func that Checks the type for City instance
        """
        city_1 = City()
