...
class TestCity_instantiation(unittest.TestCase):
    """ this Unittests is testing for instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """this Unittests is testing to save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """ this Unittests is testing to_dict method of the City class."""
