...
class TestState_instantiation(unittest.TestCase):
    """Unittests that is  testing for instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests that is testing to  save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests that is testing to_dict method of the State class."""
