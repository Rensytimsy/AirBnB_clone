...
class TestUser_instantiation(unittest.TestCase):
    """Unittests that is testing for instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """a Unittests that is testing to save method of the class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests that is testing to_dict method of the User class."""
